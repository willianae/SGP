      ...
      // cdsProduto.Close;
       ...
       begin
         ...
         qryProduto.SQL.Text :=
          ...
          '   PROD.REFERENCIA,                     '#13+
          '   PROD.DESCRICAO,                      '#13+
          '   PROD.VALOR_UNITARIO,                 '#13+
          '   PROD.QUANTIDADE,                     '#13+
          '   PROD.VALOR_TOTAL,                    '#13+
          '   CASE PROD.FLG_RECEBIDO               '#13+
          '    WHEN ''S'' THEN ''X''               '#13+
          '   ELSE '''' END  FLG_RECEBIDO,         '#13+
          '   CASE                                 '#13+
          '   WHEN BAI.DATA_EMISSAO_NF IS NULL THEN NULL   '#13+
          '  ELSE BAI.DATA_EMISSAO_NF END DATA_EMISSAO_NF, '#13+
          '   BAI.NOTA_FISCAL                      '#13+
         ...
         begin
           ...
           begin
             ...
             //if qryProduto.FieldByName('DATA_EMISSAO_NF').Value = Null then

             cdsProdutoDATA_EMISSAO_NF.AsString := qryProduto.FieldByName('DATA_EMISSAO_NF').AsString;
             cdsProdutoNOTA_FISCAL.Value     := qryProduto.FieldByName('NOTA_FISCAL').AsString;
             cdsProduto.Post;
